...
import org.gnucash.xml.sx.Schedxaction;
 ...
 *         &lt;element ref="{http://www.gnucash.org/XML/price}pricedb" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/act}account" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/trn}transaction" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/trn}template-transactions" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/sx}schedxaction" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/bgt}budget" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/billterm}GncBillTerm" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/cust}GncCustomer" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/employee}GncEmployee" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/entry}GncEntry" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/invoice}GncInvoice" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/job}GncJob" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/order}GncOrder" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/taxtable}GncTaxTable" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gnucash.org/XML/vendor}GncVendor" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class Book {
    ...
    @XmlElement(name = "template-transactions", namespace = "http://www.gnucash.org/XML/trn")
    ...
    @XmlElement(name = "GncBillTerm", namespace = "http://www.gnucash.org/XML/billterm")
    protected List<GncBillTerm> gncBillTerm;
    @XmlElement(name = "GncCustomer", namespace = "http://www.gnucash.org/XML/cust")
    protected List<GncCustomer> gncCustomer;
    @XmlElement(name = "GncEmployee", namespace = "http://www.gnucash.org/XML/employee")
    protected List<GncEmployee> gncEmployee;
    @XmlElement(name = "GncEntry", namespace = "http://www.gnucash.org/XML/entry")
    protected List<GncEntry> gncEntry;
    @XmlElement(name = "GncInvoice", namespace = "http://www.gnucash.org/XML/invoice")
    protected List<GncInvoice> gncInvoice;
    @XmlElement(name = "GncJob", namespace = "http://www.gnucash.org/XML/job")
    protected List<GncJob> gncJob;
    @XmlElement(name = "GncOrder", namespace = "http://www.gnucash.org/XML/order")
    protected List<GncOrder> gncOrder;
    @XmlElement(name = "GncTaxTable", namespace = "http://www.gnucash.org/XML/taxtable")
    protected List<GncTaxTable> gncTaxTable;
    @XmlElement(name = "GncVendor", namespace = "http://www.gnucash.org/XML/vendor")
